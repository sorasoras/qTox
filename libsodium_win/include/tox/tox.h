...
uint8_t tox_friend_get_device_count(
    const Tox *tox, uint32_t friend_number);
...
bool tox_friend_get_device_pubkey(
    const Tox *tox, uint32_t friend_number, uint8_t index,
    uint8_t device_pubkey[TOX_PUBLIC_KEY_SIZE]);
...
bool tox_friend_get_public_key(
    const Tox *tox, uint32_t friend_number, Tox_Public_Key public_key,
...
uint64_t tox_friend_get_last_online(
    const Tox *tox, uint32_t friend_number, Tox_Err_Friend_Get_Last_Online *error);
...
size_t tox_friend_get_name_size(
    const Tox *tox, uint32_t friend_number, Tox_Err_Friend_Query *error);
...
bool tox_friend_get_name(
    const Tox *tox, uint32_t friend_number, uint8_t name[], Tox_Err_Friend_Query *error);
...
bool tox_friend_get_status_message(
    const Tox *tox, uint32_t friend_number, uint8_t status_message[],
...
typedef void tox_friend_status_cb(
    Tox *tox, uint32_t friend_number, Tox_User_Status status, void *user_data);
...
typedef void tox_friend_typing_cb(
    Tox *tox, uint32_t friend_number, bool typing, void *user_data);
...
bool tox_self_set_typing(
    Tox *tox, uint32_t friend_number, bool typing, Tox_Err_Set_Typing *error);
...
typedef void tox_friend_read_receipt_cb(
    Tox *tox, uint32_t friend_number, Tox_Friend_Message_Id message_id, void *user_data);
...
typedef void tox_friend_message_cb(
    Tox *tox, uint32_t friend_number, uint64_t timestamp,
...
bool tox_file_control(
    Tox *tox, uint32_t friend_number, Tox_File_Number file_number, Tox_File_Control control,
 ...
 */
bool tox_file_seek(
    Tox *tox, uint32_t friend_number, Tox_File_Number file_number, uint64_t position, Tox_Err_File_Seek *error);
...
bool tox_file_get_file_id(
    const Tox *tox, uint32_t friend_number, Tox_File_Number file_number,
    Tox_File_Id file_id,
...
Tox_File_Number tox_file_by_id(
    const Tox *tox, uint32_t friend_number, const Tox_File_Id file_id,
...
Tox_File_Number tox_file_send(
    Tox *tox, uint32_t friend_number, uint32_t kind, uint64_t file_size,
...
bool tox_file_send_chunk(
    Tox *tox, uint32_t friend_number, Tox_File_Number file_number, uint64_t position,
...
typedef void tox_file_recv_cb(
    Tox *tox, uint32_t friend_number, Tox_File_Number file_number, uint32_t kind, uint64_t file_size,
...
bool tox_conference_invite(
    Tox *tox, uint32_t friend_number, Tox_Conference_Number conference_number,
...
bool tox_group_invite_friend(
    const Tox *tox, Tox_Group_Number group_number, uint32_t friend_number,
